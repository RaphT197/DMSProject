...
public class FFTest {
    ...
    public void setUp() {
        ...
        PCharacter testChar2 = new PCharacter("9632", "Rukki", "Dragoon", 22, 100, 4444,true);
        PCharacter testChar3 = new PCharacter("3232", "Tifa", "Warrior", 50, 9999, 4444,true);
    ...
    public void testLevelUpClampsAtMax() {
        ...
        PCharacter highLevel = new PCharacter("5678", "Tifa", "Monk", 98, 9999,4444, true);
